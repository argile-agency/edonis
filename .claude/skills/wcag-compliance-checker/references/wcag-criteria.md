# WCAG 2.1/2.2 Criteria Reference

## Principle 1: Perceivable

### 1.1 Text Alternatives
| Criterion | Level | Automated |
|-----------|-------|-----------|
...
| 1.4.12 Text Spacing | AA | Yes |
| 1.4.13 Content on Hover/Focus | AA | No |
...
| 2.1.2 No Keyboard Trap | A | Partial |
| 2.1.4 Character Key Shortcuts | A | No |

### 2.4 Navigable
| Criterion | Level | Automated |
|-----------|-------|-----------|
| 2.4.1 Bypass Blocks | A | Yes |
