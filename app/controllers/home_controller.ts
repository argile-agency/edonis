...
export default class HomeController {
  ...
  async index({ auth, inertia }: HttpContext) {
    ...
    try {
      ...
      logger.error('HomeController: failed to load user roles: %s', (error as Error).message)
      return inertia.render('home', { dashboardData: {}, dbUnavailable: true })
    }
    ...
    try {
      ...
      logger.error('HomeController: failed to load dashboard data: %s', (error as Error).message)
      return inertia.render('home', { dashboardData: {}, dbUnavailable: true })
    }
